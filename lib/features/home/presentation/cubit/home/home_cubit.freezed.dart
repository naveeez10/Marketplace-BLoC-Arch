...
class _$_Success implements _Success {
  const _$_Success(final List<Listing> listings) : _listings = listings;
  ...
  @override
  String toString() {
    return 'HomeState.success(listings: $listings)';
  }
...
abstract class _Success implements HomeState {
  const factory _Success(final List<Listing> listings) = _$_Success;
